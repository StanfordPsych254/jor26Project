...
function submitMaximize() {
	if(document.getElementById("maximizeText").value =='' || document.getElementById("maximizeText").value =='Enter text here...'){
		$("#maximizeMessage_att").html('<font color="red">' + 
				   'Please make a response!' + 
				   '</font>');
	}
	else{
		experiment.data.push(condition)
		experiment.data.push(document.getElementById("maximizeText").value);
		showSlide("rating");
	}
}
function submitControl(){
	if(document.getElementById("controlText").value =='' || document.getElementById("controlText").value =='Enter text here...'){
		$("#controlMessage_att").html('<font color="red">' + 
				   'Please make a response!' + 
				   '</font>');
	}
	else{
		experiment.data.push(condition)
		experiment.data.push(document.getElementById("controlText").value);
		showSlide("rating");
	}
...
function submitRating(){
	log_response("liking")
	experiment.data.push(document.getElementById("attention").value);
	if(response_logged == true){
...
var condition = randomElement(["Control","Maximize"]);
// slideList = [1,2,3,4,5,6,7,8];
...
var experiment = {
 ...
 // keyBindings: myKeyBindings,
  ...
  //next: function() {
    ...
    //if (experiment.mySlideList.length == 0) {
    //  experiment.end();
    //  return;
    //}
    
    // Get the current trial - <code>shift()</code> removes the first element of the array and returns it.
  //  var n=experiment.mySlideList.shift();
   // if (n==1) {
	//	showSlide("demographics")
	//}
